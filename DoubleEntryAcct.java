...
public class DoubleEntryAcct
{
    ...
    public static void main(String[] args)
    {
        ...
        /*
                ...
                B/S accounts are mostly done. Also each code block needs to have the AccounEntries class updates with the new Account object in order
        ...
        while(!done)
        {
            ...
            else if(userInput.equals("A"))
            {
                ...
                if (answer.equalsIgnoreCase("R"))
                {
                    ...
                    if (userAnswer.equalsIgnoreCase("T"))
                    {
                        ...
                        */
                        ...
                        thisCash.debitAccountsReceivable(cashCollect);
                ...
                else if(answer.equalsIgnoreCase("I"))
                {
                    ...
                    {
                        /*
                            Put in code block for option to show use/consumption of equipment and inventory accounts.
                         */
                    }
                }
